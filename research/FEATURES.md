...
## Current 1:1 audit — confirmed repairs
...
The 18 confirmed findings are now addressed in [PARITY-FIXES.md](PARITY-FIXES.md).
Passing the campaign under the port's current rules does not prove original-game
parity. Confirmed repair coverage:

- [x] Native gift/food candidate selection, three-question limit and rejection flow (01–03).
- [x] Native clothing four-chance state machine (04).
- [x] Clothes/window design and music first/return/completion voice sequences (05–07).
- [x] First Zine and scrapbook entry/tab guidance (08–09).
- [x] Gift/food, accessories/makeup and CD-shop automatic dialogue and CD ambience (10–13).
- [x] Music/apartment Help, meaningful audio cues, insufficient-money flow and original shop layout (14–18).
...
- [x] Context-sensitive help/idle routing, including music stage and visited-apartment dictionaries (parity audit 14–15).
